        ...
        return {
            user: {
                signin: function(user) {
                    return $http.post("/user/signin", { loginId: user.loginId, password: user.password });
                },
                signup: function(user) {
                    return $http.post("/user/signup", { loginId: user.loginId, password: user.password, email: user.email });
                },
                // get_me: function() {
                //     return $http.get("/api/user");
                // },
                update: function(id, fields) {
                    return $http.put("/user/edit", { id: id, fields: fields });
                },
            ...
            note: {
                ...
                readings: function() {
                    return $http.get('/note/readings')
                },
                travels: function() {
                    return $http.get('/note/travels')
                },
